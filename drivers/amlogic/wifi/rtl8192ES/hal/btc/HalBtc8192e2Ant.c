...
u32	glcoex_ver_date_8192e_2ant = 20151214;
		...
		IN boolean force_exec, IN u8 type)
{
	...
	case 1:
		...
		break;
	case 2:
		halbtc8192e2ant_coex_table(btcoexist, force_exec, 0x55555555, 0x5ffb5ffb, 0xffffff, 0x3);
		break;
	case 3:
		     ...
		     IN boolean force_exec, IN boolean turn_on, IN u8 type)
{
	...
	if (turn_on) {
		...
		case 21:
			...
			break;
		case 22:	//d1,wb
			halbtc8192e2ant_set_fw_pstdma(btcoexist, 0xe3, 0x1e, 0x03, 0x11, 0x14);
			break;	
		case 23: 	//d1,pb,TXpause
			halbtc8192e2ant_set_fw_pstdma(btcoexist, 0x63, 0x1e, 0x03, 0x90, 0x14);
			break;
		case 24: 	//d1,bb
			halbtc8192e2ant_set_fw_pstdma(btcoexist, 0xe3, 0x1e, 0x03, 0x31, 0x14);
			break;
		case 25:	//d1,bb,TXpause
			halbtc8192e2ant_set_fw_pstdma(btcoexist, 0xe3, 0x1e, 0x03, 0x30, 0x14);
			break;
		case 71:
		...
		case 80:
			halbtc8192e2ant_set_fw_pstdma(btcoexist, 0x53, 0x3c, 0x3, 0x90, 0x50);
			break;
		case 81:
			halbtc8192e2ant_set_fw_pstdma(btcoexist, 0x53, 0x3a+nWiFiDurationAdjust, 0x3, 0x90, 0x50);
			break;
		case 82:
			halbtc8192e2ant_set_fw_pstdma(btcoexist, 0x53, 0x30+nWiFiDurationAdjust, 0x03, 0x90, 0x50);
			break;
   		case 83:
   			halbtc8192e2ant_set_fw_pstdma(btcoexist, 0x53, 0x21, 0x03, 0x90, 0x50);
   			break;
   		case 84:
   			halbtc8192e2ant_set_fw_pstdma(btcoexist, 0x53, 0x15, 0x3, 0x90, 0x50);
   			break;
   		case 85:
   			halbtc8192e2ant_set_fw_pstdma(btcoexist, 0x53, 0x3a, 0x03, 0x90, 0x50);
   			break;
   		case 86:
   			halbtc8192e2ant_set_fw_pstdma(btcoexist, 0x53, 0x21, 0x03, 0x90, 0x50);
   			break;
		case 87:
			halbtc8192e2ant_set_fw_pstdma(btcoexist, 0x53, 0x1e, 0x03, 0x90, 0x54);
			break;
