...
u1Byte gDeltaSwingTableIdx_MP_2GB_N_TxPowerTrack_SDIO_8192E[]    = {0, 1, 1, 1, 2, 2, 3, 3, 4, 4, 8, 5, 8, 9, 6, 8, 9, 12, 12, 12, 12, 14, 14, 12, 12, 11, 12, 12, 12, 13};
u1Byte gDeltaSwingTableIdx_MP_2GB_P_TxPowerTrack_SDIO_8192E[]    = {0, 0, 0, 1, 2, 2, 5, 5, 6, 5, 11, 9, 9, 11, 9, 9, 13, 14, 15, 17, 17, 18, 19, 19, 19, 19, 19, 13, 19, 19};
u1Byte gDeltaSwingTableIdx_MP_2GA_N_TxPowerTrack_SDIO_8192E[]    = {0, 1, 1, 0, 2, 2, 1, 3, 4, 4, 8, 6, 8, 10, 9, 8, 9, 12, 12, 12, 11, 14, 14, 11, 12, 11, 12, 12, 12, 13};
u1Byte gDeltaSwingTableIdx_MP_2GA_P_TxPowerTrack_SDIO_8192E[]    = {0, 0, 0, 2, 2, 4, 2, 3, 4, 5, 15, 9, 12, 6, 9, 9, 17, 14, 15, 17, 17, 18, 19, 19, 19, 19, 19, 19, 19, 19};
u1Byte gDeltaSwingTableIdx_MP_2GCCKB_N_TxPowerTrack_SDIO_8192E[] = {0, 1, 1, 1, 2, 2, 3, 3, 4, 4, 8, 6, 6, 11, 7, 7, 9, 8, 9, 9, 13, 9, 9, 10, 10, 10, 11, 12, 12, 13};
u1Byte gDeltaSwingTableIdx_MP_2GCCKB_P_TxPowerTrack_SDIO_8192E[] = {0, 1, 1, 3, 3, 3, 3, 3, 4, 5, 5, 5, 6, 7, 7, 8, 9, 9, 9, 9, 10, 11, 12, 12, 12, 13, 13, 14, 15, 16};
u1Byte gDeltaSwingTableIdx_MP_2GCCKA_N_TxPowerTrack_SDIO_8192E[] = {0, 1, 1, 0, 3, 3, 3, 2, 5, 5, 10, 7, 9, 11, 8, 9, 8, 14, 12, 10, 14, 10, 11, 11, 11, 12, 11, 11, 12, 13};
u1Byte gDeltaSwingTableIdx_MP_2GCCKA_P_TxPowerTrack_SDIO_8192E[] = {0, 1, 1, 3, 3, 3, 3, 2, 1, 5, 4, 5, 7, 6, 7, 8, 9, 9, 9, 9, 10, 11, 12, 12, 12, 13, 13, 14, 15, 16};
#endif
...
u1Byte gDeltaSwingTableIdx_MP_2GB_N_TxPowerTrack_USB_8192E[]    = {0, 1, 1, 1, 1, 1, 1, 0, 1, 1, 6, 2, 6, 2, 0, 7, 2, 1, 2, 9, 1, 0, 9, 10, 0, 11, 11, 12, 12, 13};
u1Byte gDeltaSwingTableIdx_MP_2GB_P_TxPowerTrack_USB_8192E[]    = {1, 0, 0, 1, 2, 2, 2, 3, 11, 4, 5, 5, 12, 13, 6, 7, 15, 17, 9, 16, 9, 21, 19, 12, 12, 12, 12, 13, 19, 19};
u1Byte gDeltaSwingTableIdx_MP_2GA_N_TxPowerTrack_USB_8192E[]    = {0, 1, 1, 1, 2, 2, 4, 3, 5, 4, 10, 5, 6, 7, 7, 3, 8, 10, 13, 11, 9, 9, 9, 10, 11, 11, 12, 12, 12, 13};
u1Byte gDeltaSwingTableIdx_MP_2GA_P_TxPowerTrack_USB_8192E[]    = {0, 0, 1, 1, 5, 4, 2, 3, 8, 4, 5, 5, 12, 13, 6, 7, 15, 17, 9, 12, 9, 17, 13, 12, 12, 12, 12, 13, 19, 19};
u1Byte gDeltaSwingTableIdx_MP_2GCCKB_N_TxPowerTrack_USB_8192E[] = {0, 1, 1, 1, 2, 2, 3, 3, 4, 4, 8, 6, 7, 7, 6, 7, 8, 8, 9, 9, 8, 8, 9, 10, 10, 11, 11, 12, 12, 13};
u1Byte gDeltaSwingTableIdx_MP_2GCCKB_P_TxPowerTrack_USB_8192E[] = {0, 1, 2, 2, 2, 4, 4, 4, 7, 6, 6, 6, 8, 7, 7, 8, 11, 10, 9, 11, 10, 12, 10, 13, 11, 12, 12, 13, 14, 16};
u1Byte gDeltaSwingTableIdx_MP_2GCCKA_N_TxPowerTrack_USB_8192E[] = {0, 1, 1, 1, 3, 4, 3, 3, 6, 5, 9, 7, 9, 7, 7, 9, 8, 12, 11, 9, 11, 9, 9, 10, 10, 11, 11, 11, 12, 13};
u1Byte gDeltaSwingTableIdx_MP_2GCCKA_P_TxPowerTrack_USB_8192E[] = {0, 1, 1, 2, 2, 4, 3, 5, 7, 6, 6, 6, 8, 7, 7, 8, 10, 10, 9, 10, 10, 12, 12, 11, 11, 12, 12, 13, 14, 16};
#endif
