...
union	reg_bitfield {
	unsigned int	wvalue;
	struct {
		unsigned int	bit0 : 1;	/* GPIOX.0 */
		unsigned int	wr : 1;		/* GPIOX.1 */
		unsigned int	db03 : 1;	/* GPIOX.2 */
		unsigned int	db01 : 1;	/* GPIOX.3 */
		unsigned int	db04 : 1;	/* GPIOX.4 */
		unsigned int	db00 : 1;	/* GPIOX.5 */
		unsigned int	bit6 : 1;	/* GPIOX.6 */
		unsigned int	db05 : 1;	/* GPIOX.7 */
		unsigned int	db02 : 1;	/* GPIOX.8 */
		unsigned int	db06 : 1;	/* GPIOX.9 */

		unsigned int	bit10 : 1;	/* GPIOX.10 */
		unsigned int	db07 : 1;	/* GPIOX.11 */
		/* GPIOX.12 ~ GPIOX.31 */
...
#endif /* #if defined(CONFIG_ARCH_MESON64_ODROIDC2) */
