...
#define TEGRA_SE_TIMEOUT_1S	1000000
...
#define SE_KEYTABLE_DATA_REG_OFFSET	0x320
...
#define SE_STATUS_REG_OFFSET			0x800
#define SE_STATUS_MEM_INTERFACE_SHIFT	2
#define MEM_INTERFACE_IDLE				0
#define MEM_INTERFACE_BUSY				1
#define SE_STATUS_MEM_INTERFACE(x)	(x << SE_STATUS_MEM_INTERFACE_SHIFT)
...
#define SE_KEYTABLE_IVWORD_SHIFT			0
#define SE_KEYTABLE_IV_WORD(x)			(x << SE_KEYTABLE_IVWORD_SHIFT)
